...
namespace UbiCom.Net.Utility
{
    internal static class Converter
    {
        ...
        internal static byte[] ConvertDoubles2Bytes(double[] value)
        {
            ...
            for (int i = 0; i < value.Length; i++)
            {
                valueTemp = ConvertDouble2Bytes(value[i], 8);
        ...
        internal static int ConvertBytes2Int(byte[] value, int length)
        {
            ...
            {
                case 1:
                    result = (int)((uint)value[0]);
                    break;
                case 2:
                    value = Swap(value, length);
                    result = (int)BitConverter.ToUInt16(value, 0);
                    if (result < 0)
                ...
                case 3:
                    {
                        ...
                        result = (int)BitConverter.ToUInt32(padded, 0);
                        if (result < 0)
                            result = (int)(result + UInt32.MaxValue);
                    }
                    break;
                case 4:
                    value = Swap(value, length);
        ...
        internal static uint ConvertBytes2Uint(byte[] value, int length)
        {
            uint result;
            ...
            {
                case 1:
                    result = (uint)(value[0] & 0xff);

                    break;
                case 2:
                    value = Swap(value, length);
                    result = (uint)BitConverter.ToUInt32(value, 0);
                    if (result < 0)
                        result += ushort.MaxValue;
                    break;
                case 4:
                    ...
                    result = (uint)BitConverter.ToUInt32(value, 0);
                    if (result < 0)
                        result = (uint)(result + UInt32.MaxValue);
                    break;
                case 8:
                    value = Swap(value, length);
                    result = (uint)BitConverter.ToUInt64(value, 0);
                    if (result < 0)
                        result = (uint)(result + UInt32.MaxValue);
                    break;
                default:
