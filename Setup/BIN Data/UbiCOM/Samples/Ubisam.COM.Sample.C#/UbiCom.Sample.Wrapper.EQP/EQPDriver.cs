...
namespace UbiCom.Sample.Wrapper.EQP
{
    ...
    ///
    /// </summary>
    public class EQPDriver : HSMSDriver
    {
        #region [Delegate / Event Define]
        public delegate void S1F1ReceivedEventHandler(CS1F1 S1F1);
        public delegate void S2F41ReceivedEventHandler(CS2F41 S2F41);
        public delegate void S1F2_ToEqpReceivedEventHandler(SECSMessage primaryMessage, CS1F2_ToEqp S1F2_ToEqp);
        public delegate void S6F12ReceivedEventHandler(SECSMessage primaryMessage, CS6F12 S6F12);
        public delegate void S2F80_L0ReceivedEventHandler(SECSMessage primaryMessage, CS2F80_L0 S2F80_L0);
        public delegate void S2F80_L21ReceivedEventHandler(SECSMessage primaryMessage, CS2F80_L21 S2F80_L21);

        public event S1F1ReceivedEventHandler OnS1F1Received;
        public event S2F41ReceivedEventHandler OnS2F41Received;
        public event S1F2_ToEqpReceivedEventHandler OnS1F2_ToEqpReceived;
        public event S6F12ReceivedEventHandler OnS6F12Received;
        public event S2F80_L0ReceivedEventHandler OnS2F80_L0Received;
        public event S2F80_L21ReceivedEventHandler OnS2F80_L21Received;
        #endregion

        #region Constructor
        public EQPDriver()
        {
            this.OnReceivedPrimaryMessage += new ReceivedPrimaryMessageEventHandler(EQPDriver_OnReceivedPrimaryMessage);
            this.OnReceivedSecondaryMessage += new ReceivedSecondaryMessageEventHandler(EQPDriver_OnReceivedSecondaryMessage);
        }
        #endregion

        // Driver Event
        #region EQPDriver_OnReceivedPrimaryMessage
        void EQPDriver_OnReceivedPrimaryMessage(object sender, SECSMessage message)
        {
            switch (message.Name)
            {
                case "S1F1":
                    ...
                    break;
                case "S2F41":
                    CS2F41 S2F41 = new CS2F41(this, "S2F41");

                    S2F41.SystemBytes = message.SystemBytes;
                    S2F41.Body = message.Body;

                    ConvertWrapper(S2F41, message);

                    if (this.OnS2F41Received != null)
                        this.OnS2F41Received(S2F41);

                    break;
            }
        }
        #endregion
        #region EQPDriver_OnReceivedSecondaryMessage
        void EQPDriver_OnReceivedSecondaryMessage(object sender, SECSMessage primaryMessage, SECSMessage secondaryMessage)
        {
            switch (secondaryMessage.Name)
            {
                case "S1F2_ToEqp":
                    CS1F2_ToEqp S1F2_ToEqp = new CS1F2_ToEqp(this, "S1F2_ToEqp");

                    S1F2_ToEqp.SystemBytes = secondaryMessage.SystemBytes;
                    S1F2_ToEqp.Body = secondaryMessage.Body;

                    ConvertWrapper(S1F2_ToEqp, secondaryMessage);

                    if (this.OnS1F2_ToEqpReceived != null)
                        this.OnS1F2_ToEqpReceived(primaryMessage, S1F2_ToEqp);

                    break;
                case "S6F12":
                    CS6F12 S6F12 = new CS6F12(this, "S6F12");

                    S6F12.SystemBytes = secondaryMessage.SystemBytes;
                    S6F12.Body = secondaryMessage.Body;

                    ConvertWrapper(S6F12, secondaryMessage);

                    if (this.OnS6F12Received != null)
                        this.OnS6F12Received(primaryMessage, S6F12);

                    break;
                case "S2F80_L0":
                    CS2F80_L0 S2F80_L0 = new CS2F80_L0(this, "S2F80_L0");

                    S2F80_L0.SystemBytes = secondaryMessage.SystemBytes;
                    S2F80_L0.Body = secondaryMessage.Body;

                    ConvertWrapper(S2F80_L0, secondaryMessage);

                    if (this.OnS2F80_L0Received != null)
                        this.OnS2F80_L0Received(primaryMessage, S2F80_L0);

                    break;
                case "S2F80_L21":
                    CS2F80_L21 S2F80_L21 = new CS2F80_L21(this, "S2F80_L21");

                    S2F80_L21.SystemBytes = secondaryMessage.SystemBytes;
                    S2F80_L21.Body = secondaryMessage.Body;

                    ConvertWrapper(S2F80_L21, secondaryMessage);

                    if (this.OnS2F80_L21Received != null)
                        this.OnS2F80_L21Received(primaryMessage, S2F80_L21);
    ...
    [Serializable]
    public class CS1F2_ToHost : SECSMessageReply
    {
        #region [L]
    ...
    [Serializable]
    public class CS1F2_ToEqp : SECSMessageReceive
    {
        #region [L]
        public class CL : SECSItemCollectionWrapper
        {
    ...
    [Serializable]
    public class CS2F41 : SECSMessageReceive
    {
        #region [L]
        public class CL : SECSItemCollectionWrapper
        {
    ...
    [Serializable]
    public class CS2F42 : SECSMessageReply
    {
        #region [L]
        public class CL : SECSItemCollectionWrapper
        {
    ...
    [Serializable]
    public class CS6F11 : SECSMessageRequest
    {
        #region [L]
        public class CL : SECSItemCollectionWrapper
        {
    ...
    [Serializable]
    public class CS6F12 : SECSMessageReceive
    {
    ...
    [Serializable]
    public class CS2F79 : SECSMessageRequest
    {
        #region [L]
        public class CL : SECSItemCollectionWrapper
        {
    ...
    [Serializable]
    public class CS2F80_L0 : SECSMessageReceive
    {
        #region [L]
        public class CL : SECSItemCollectionWrapper
        {
    ...
    [Serializable]
    public class CS2F80_L21 : SECSMessageReceive
    {
        #region [L]
        public class CL : SECSItemCollectionWrapper
        {
