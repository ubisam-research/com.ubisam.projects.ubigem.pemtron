...
// Ubisam.COM.Sample.CPP.HostDlg.h : 헤더 파일
//
...
class CUbisamCOMSampleCPPHostDlg : public CDialogEx, UbiCom::CPP::IHSMSDriverEvents
{
// 생성입니다.
public:
	CUbisamCOMSampleCPPHostDlg(CWnd* pParent = NULL);	// 표준 생성자입니다.

// 대화 상자 데이터입니다.
	enum { IDD = IDD_UBISAMCOMSAMPLECPPHOST_DIALOG };
...
public:
	...
	afx_msg void OnBnClickedSendS2f41();

private:
	void AnalyzeS6F11(UbiCom::CPP::SECSMessage* message);
	void RetrievingS6F11V(CString& log, int logDepth, UbiCom::CPP::SECSItemCollection* collection);
};
